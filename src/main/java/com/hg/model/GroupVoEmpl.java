...
public class GroupVoEmpl {
	...
	public GroupVoEmpl(Long id, String jobNumber, String userName,
			String startTime, String endTime, String nationality,
			String maritalStatus, String gender, String education,
			String identificationNumber, String birthday, String age,
			String name, String groupName, String station, String structure,
			String residence, String currentAddress, String contactNumber,
			String inDate, String ageOfWork, String probationPeriod,
			String departureDate, String socialSecurityNumber,
			String providentFundAccount, String remarks, String poStartDate,
			String poEndDate, String supplementalAgreement,
			String identityCardStart, String identityCardEnd, String major,
			String graduateFrom, String studyStart, String studyEnd,
			String schoolModel, String certificateNumber, String studyForm,
			String credential, String travellingCrane, String forklift,
			String electricSoldering, String safetyOfficer,
			String electricianCertificate, String workLocation, String month,
			String retireDate, String line) {
		super();
		this.id = id;
		this.jobNumber = jobNumber;
		this.userName = userName;
